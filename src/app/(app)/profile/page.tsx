  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute top-[-10%] right-[-10%] w-[50vw] h-[50vw] bg-gold/5 blur-[120px] rounded-full transform-gpu" />
        <div className="absolute bottom-[20%] left-[-20%] w-[40vw] h-[40vw] bg-gold/5 blur-[100px] rounded-full transform-gpu" />
      </div>
