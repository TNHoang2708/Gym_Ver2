...
- [x] 5. Write `requestHealthPermissions()` to prompt the user natively.
- [x] 6. Write `queryDailySteps()` to fetch the total steps from midnight to current time.
- [x] 7. Write `querySleepData()` to fetch the total minutes of sleep from the previous night.
...
- [x] 4. Test the AI response: Manually inject a sleep value of 3 hours and verify the AI suggests a lighter recovery day.
