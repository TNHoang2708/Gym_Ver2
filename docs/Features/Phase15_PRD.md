...
- [x] 3. Ensure the active state highlighting works correctly when navigating to `/community`.

---
**Status:** ~70% Complete (DB schema done, UI exists, but likes/comments are just stub implementations)
